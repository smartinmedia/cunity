...
class Version1429698302 extends DbUpdateVersion implements DbCommandInterface
{
    ...
    {
        $this->_db->query("CREATE TABLE IF NOT EXISTS `".$this->_db->getDbprefix()."newsletter` (`id` int(11) NOT NULL AUTO_INCREMENT, `time` TIMESTAMP NOT NULL, `subject` text NOT NULL, `message` TEXT NOT NULL, `userid` int(11) NOT NULL, PRIMARY KEY (`id`) ) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1");
