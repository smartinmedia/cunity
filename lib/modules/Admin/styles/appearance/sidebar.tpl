    ...
    <div class="col-lg-12">
        <div class="panel panel-default" id="editPagePanel">
            ...
            <div class="panel-body">
                <form class="ajaxform" action="{-"index.php?m=admin&action=settings"|URL}" id="pageform" method="POST">
                    <div class="form-group">
                        <label for="title" class="control-label">{-"Page-Title"|translate}</label>
                        <input type="text" required name="title" class="form-control" id="pages-title"
                               placeholder="{-"Choose a short Title for this page"|translate}">
                    </div>
                    <div class="form-group">
                        <label for="title" class="control-label">{-"Page-Content"|translate}</label>

                        <div id="pages-summernote"></div>
                        <input type="hidden" required name="content">
                    </div>
                    {-*<div class="form-group">
                    <div class="checkbox">
                    <label>
            ...
            <div class="panel-footer clearfix">
                ...
                <button class="btn btn-primary pull-right editpagebutton hidden" onclick="$('#pageform').submit();" id="refresh"><i
                            class="fa fa-refresh" id="refresh"></i>&nbsp;{-"Update page"|translate}</button>
