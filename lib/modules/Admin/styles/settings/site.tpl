            ...
            <div class="panel-body">
                <form class="form-horizontal ajaxform form-validate" id="general-form" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" value="{-"core.sitename"|setting}" id="cunity-name"
                                   name="settings-core.sitename" required data-bv-stringlength data-bv-stringlength-min="3"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="text" class="form-control" placeholder="e.g. (http://www.example.com)"
                                   id="cunity-name" value="{-"core.siteurl"|setting}" name="settings-core.siteurl" required data-bv-stringlength data-bv-stringlength-min="11"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <textarea id="cunity-description" rows="3" class="form-control" name="settings-core.description"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-8">
                            <input type="email" class="form-control" value="{-"core.contact_mail"|setting}" id="contact-mail"
