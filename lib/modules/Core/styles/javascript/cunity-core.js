var origShow = jQuery.fn.show, origHide = jQuery.fn.hide, inactiveCounter = 0, cStorage = new CunityStorage("session"), postid = 0;
...
function checkImage(filename, type, prefix, postid) {
...
$(document).ready(function() {
    ...
    $(document).on("click", "#menu-trigger", function() {
        if (login) {
            ...
            location.href = convertUrl({module: "start"});
    }).on("mouseenter", ".notification-item:not(.read)", function() {
        var el = $(this);
