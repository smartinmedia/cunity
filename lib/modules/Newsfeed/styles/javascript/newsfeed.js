...
$(document).ready(function () {
    ...
    $('#postmsg').keyup(function() {
        if ($('#postmsg').val() != '') {
            if ($('.newsfeed-post-file-input > button').is(':visible')) {
                $('#newsfeed-post-text-button').attr('disabled', 'disabled');
            } else {
                $('#newsfeed-post-photo-button').attr('disabled', 'disabled');
            }
        } else {
            $('#newsfeed-post-photo-button').removeAttr('disabled');
            $('#newsfeed-post-text-button').removeAttr('disabled');
        }
    });
