...
<ul class="nav nav-pills profile-menu" id="profile-menu">
    ...
    <li class=""><a href="#editPrivacy" id="profile-menu-edit-privacy" data-toggle="pill"><i class="fa fa-lock"></i>&nbsp;{-"Privacy"|translate}</a>
    </li>
...
<div class="tab-content" style="border-top:1px solid #ccc;padding-top:10px">
    <div class="tab-pane active clearfix" id="editAccount">
        <div class="col-md-3">
            <div class="list-group">
                <a href="#editAccountGeneral" class="list-group-item active" data-toggle="tab">{-"General"|translate}</a>
                <a href="#editAccountChangePwd" class="list-group-item" data-toggle="tab">{-"Change password"|translate}</a>
        ...
        <div class="col-md-9 tab-content section-content">
            <div class="tab-pane active panel panel-default" id="editAccountGeneral">
                ...
                <div class="panel-body">
                    ...
                    <form action="{-"index.php?m=profile&action=edit"|URL}" method="post" class="form-horizontal ajaxform">
    ...
    <div class="tab-pane clearfix" id="editPrivacy">
        <div class="col-md-3">
            <div class="list-group">
                <a href="#editPrivacyGeneral" class="list-group-item active" data-toggle="tab">{-"General"|translate}</a>
            </div>
        </div>
        <div class="col-md-9 tab-content section-content">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group clearfix">
                            <div class="col-md-9">
                                <button type="button" class="btn btn-link text-danger image-delete" data-type="profile"><i
            ...
            <div class="tab-pane panel panel-default" id="editTitleImage">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            <div class="col-md-9">
                                <button type="button" class="btn btn-link text-danger image-delete" data-type="title"><i
