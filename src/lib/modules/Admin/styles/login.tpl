...
<head>
    ...
    <script src="{-"core.siteurl"|setting}lib/plugins/bootstrap-validator/js/bootstrapValidator.min.js" type="text/javascript"></script>
...
<div class="container">
    ...
    <div class="login-extra">
        <a href="{-"core.siteurl"|setting}"><i class="fa fa-angle-double-left"></i>&nbsp;{-"Back to your Cunity"|translate}
        </a>
    </div>
    <!-- /login-extra -->
</div>
